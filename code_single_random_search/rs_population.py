...
class RandomSearch:
    ...
    def __init__(self, N, MAX_EVALUATIONS, PROB_DIMEINTION):
        ...
        self.Xs = [] #must be modified to "array" for population-based random search
        self.Fs = [] #must be modified to "array" for population-based random search 
        self.BestX = None
        self.BestFX = None
...
if __name__ == "__main__":
    ...
    #Do not change
    N, MAX_EVALUATIONS, PROB_DIMEINTION = 100, 10000, 50 # N must be 1 for single-based random search 
